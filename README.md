...
C# WinForms 기반의 세그멘테이션 라벨링 및 세그멘테이션 테스트 툴입니다.
YOLO 세그멘테이션 모델을 활용한 자동 라벨링 및 정합 기능을 제공합니다.

## 🚀 주요 기능
* **자동 세그멘테이션 (SEGMENT.cs):** YOLO 모델을 이용한 이미지 객체 분할 및 자동 라벨링 처리 및 세크멘테이션 테스트
